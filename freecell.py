...
SAMPLE_TABLEAU_2 =[
    [('J','H'),('5','H'),('4','S'),('10','H'),('K','C'),('2','S'),('3','D')],
    [('K','D'),('Q','S'),('J','D'),('6','S'),('2','H'),('4','H'),('3','H')],
    [('3','C'),('Q','C'),('A','S'),('10','D'),('9','H'),('K','H'),('8','C')],
    [('9','C'),('A','H'),('A','C'),('7','H'),('6','D'),('6','C'),('10','C')],
    [('2','C'),('10','S'),('K','S'),('8','S'),('A','D'),('J','S'),],
    [('8','H'),('4','D'),('9','D'),('5','S'),('J','C'),('9','S'),],
    [('Q','H'),('3','S'),('2','D'),('4','C'),('7','D'),('8','D'),],
    [('5','C'),('7','C'),('5','D'),('Q','D'),('6','H'),('7','S'),],
]

SAMPLE_TABLEAU_3 =[
    [('6','D'),('2','C'),('4','H'),('Q','C'),('9','S'),('4','D'),('J','H')],
    [('J','S'),('9','C'),('3','H'),('7','H'),('A','S'),('10','C'),('4','S')],
    [('10','S'),('A','C'),('8','C'),('5','C'),('A','H'),('3','C'),('5','H')],
    [('K','S'),('Q','D'),('7','S'),('8','S'),('2','S'),('K','D'),('6','C')],
    [('9','H'),('6','H'),('10','H'),('6','S'),('K','H'),('2','D'),],
    [('9','D'),('J','D'),('7','C'),('J','C'),('5','D'),('8','D'),],
    [('Q','S'),('A','D'),('Q','H'),('5','S'),('2','H'),('3','S'),],
    [('3','D'),('7','D'),('4','C'),('K','C'),('10','D'),('8','H'),],
]

SAMPLE_TABLEAU_4 =[
    [('9','S'),('2','C'),('10','C'),('Q','C'),('A','S'),('6','H'),('A','D')],
    [('8','D'),('K','D'),('A','C'),('5','H'),('7','C'),('5','D'),('9','H')],
    [('A','H'),('J','C'),('4','D'),('8','C'),('K','C'),('4','S'),('10','D')],
    [('K','H'),('10','S'),('7','D'),('6','C'),('7','H'),('4','C'),('2','H')],
    [('J','H'),('3','C'),('8','H'),('9','C'),('Q','S'),('5','S'),],
    [('10','H'),('6','D'),('Q','H'),('2','S'),('8','S'),('4','H'),],
    [('J','D'),('J','S'),('9','D'),('6','S'),('3','D'),('5','C'),],
    [('2','D'),('K','S'),('Q','D'),('7','S'),('3','S'),('3','H'),],
]
INITIAL_BOARL_SAMPLE = {
        'freecells': [],
        'home_cells': [[], [], [], []],
        'tableau': SAMPLE_TABLEAU_4,
    }
...
def heuristic(board):
    ...
    return (- home_cells_count * 70
            ...
            - free_spaces * 10
            - empty_tableau_cols * 20
            - king_starting_cols * 15
